...
That said, if you want dive deeper while evaluating Azure Media Services, you can read the documents listed in the references section below or get your hands dirty with the quickstarts, tutorials and samples in the [Azure Media Services documentation](/azure/media-services/latest/).
