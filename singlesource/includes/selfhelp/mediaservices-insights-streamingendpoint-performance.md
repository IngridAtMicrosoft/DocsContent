...
- [Monitor Media Services metrics](/azure/media-services/latest/media-services-metrics-howto)
- [Streaming Endpoint metrics](/azure/media-services/latest/media-services-metrics-diagnostic-logs#streaming-endpoint)

## **Recommended Documents**

* [Azure Media Services v3 quotas and limitations](/azure/media-services/latest/limits-quotas-constraints)
* [Streaming Endpoints concept](/azure/media-services/latest/streaming-endpoint-concept)
* [Working with CDN](/azure/media-services/latest/streaming-endpoint-concept#working-with-cdn)
* [Azure CDN](/azure/cdn/cdn-overview)
