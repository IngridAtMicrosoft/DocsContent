...
Currently, you cannot use the Azure portal to manage v3 resources. Use the [REST API](/rest/api/media/account-filters), [CLI](/cli/azure/ams?view=azure-cli-latest), or one of the supported [SDKs](/azure/media-services/latest/media-services-apis-overview).
