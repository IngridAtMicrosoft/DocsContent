...
|---|---|---|---|---|---|---|
|`PoolAllocationChange` |Pool Allocation Change |[AVNMIPAMPoolAllocationChange](/azure/azure-monitor/reference/tables/avnmipampoolallocationchange)<p>Includes changes to allocations of an IPAM Pool such as Virtual Networks, static CIDRs, or child pools.|Yes|No|[Queries](/azure/azure-monitor/reference/queries/avnmipampoolallocationchange)|Yes |