...
|`GrafanaUsageInsightsEvents` |Grafana Usage Insights Events |[AGSGrafanaUsageInsightsEvents](/azure/azure-monitor/reference/tables/agsgrafanausageinsightsevents)<p>Usage insights events for an instance of Azure Managed Workspace for Grafana.|No|No||Yes |