...
|---|---|---|---|---|---|---|
|`AgentHealthStatus` |Agent Health Status ||No|No||Yes |
|`ConnectionEvent` |Connections ||No|No||Yes |
...
|`Usage` |Billing events |[DevCenterBillingEventLogs](/azure/azure-monitor/reference/tables/devcenterbillingeventlogs)<p>Billing event related to DevCenter resources. Logs contains information about the quantity and unit charged per meter.|Yes|No|[Queries](/azure/azure-monitor/reference/queries/devcenterbillingeventlogs)|Yes |