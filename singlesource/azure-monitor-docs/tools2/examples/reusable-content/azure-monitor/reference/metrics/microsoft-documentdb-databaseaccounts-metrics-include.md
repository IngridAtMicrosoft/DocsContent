...
|**Cassandra Connector Average ReplicationLatency**<br><br>Cassandra Connector Average ReplicationLatency |`CassandraConnectorAvgReplicationLatency` |MilliSeconds |Average |\<none\>|PT5M |No|
|**Cassandra Connector Replication Health Status**<br><br>Cassandra Connector Replication Health Status |`CassandraConnectorReplicationHealthStatus` |Count |Count |`NotStarted`, `ReplicationInProgress`, `Error`|PT5M |No|
