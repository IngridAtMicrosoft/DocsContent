...
|**Available Memory Percentage (Preview)**<br><br>Amount of physical memory, in percentage, immediately available for allocation to a process or for system use in the Virtual Machine |`Available Memory Percentage` |Percent |Average |`RoleInstanceId`, `RoleId`|PT1M |Yes|
