...
|**Average Connectivity Probe Availability**<br><br>Average of connectivity probe availability |`ConnectivityProbeAvailability` |Percent |Average |`Protocol`|PT1M, PT5M, PT30M, PT1H, PT6H, PT1D |Yes|
|**Average Connectivity Probe Jitter**<br><br>Average of connectivity probe jitter |`ConnectivityProbeJitter` |Milliseconds |Average |`Protocol`|PT1M, PT5M, PT30M, PT1H, PT6H, PT1D |Yes|
|**Average Connectivity Probe Latency**<br><br>Average of connectivity probe latency |`ConnectivityProbeLatency` |Milliseconds |Average |`Protocol`|PT1M, PT5M, PT30M, PT1H, PT6H, PT1D |Yes|
