...
|---|---|---|---|---|---|---|
|**Ingress Memory Usage Bytes**<br><br>Ingress pods usage memory in bytes. Represents the total memory consumed by a container |`IngressUsageBytes` |Bytes |Total (Sum), Average, Maximum, Minimum |`workloadProfileName`, `podName`|PT1M |Yes|
|**Ingress CPU Usage**<br><br>CPU consumed by the ingress pods in nano cores. 1,000,000,000 nano cores = 1 core |`IngressUsageNanoCores` |NanoCores |Total (Sum), Average, Maximum, Minimum |`workloadProfileName`, `podName`|PT1M |Yes|
