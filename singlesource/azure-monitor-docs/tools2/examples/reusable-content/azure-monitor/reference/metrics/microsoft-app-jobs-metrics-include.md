...
|**Job Restart Count**<br><br>Restart count of Container App Job execution |`RestartCount` |Count |Average, Total (Sum), Maximum, Minimum |`state`, `jobName`, `executionName`|PT1M |Yes|
