...
Media sent to a media stream can be relayed to other services, for example to stream to stream to social media services.
...
[!INCLUDE [<csharp-media-stream-relay-create>](../includes/csharp-media-stream-relay-create.md)]

#### [HTTP](#tab/http)

[!INCLUDE [<http-media-stream-relay-create](../includes/http-media-stream-relay-create.md)]
