...
[Learn about the different options for managing multiple tenants with Video Indexer](https://docs.microsoft.com/azure/media-services/video-indexer/manage-multiple-tenants). Choose a method that is most suitable for your scenario:
