---
title: no title mediaservices-analyzing-and-indexing-how-to-v2.md
...
authors: no authors mediaservices-analyzing-and-indexing-how-to-v2.md
...
The following tutorial demonstrates how to use the [VideoAnalyzerPreset](https://docs.microsoft.com/rest/api/media/transforms/createorupdate#videoanalyzerpreset): [Tutorial: Analyze videos with Azure Media Services](https://docs.microsoft.com/azure/media-services/latest/analyze-videos-tutorial).
...
* [Tutorial: Analyze Videos with Azure Media Services](https://docs.microsoft.com/azure/media-services/latest/analyze-videos-tutorial)
